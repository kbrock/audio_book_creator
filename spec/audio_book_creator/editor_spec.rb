...
describe AudioBookCreator::Editor do
  ...
  it "should generate a page" do
    expect(subject.parse([web_page("page1", "<h1>the title</h1>",
  ...
  it "should respect content path" do
    ...
    expect(subject.parse([web_page("page1", "<h3>the title</h3>",
  ...
  it "should parse multiple pages" do
    expect(subject.parse([web_page("page1", "<h1>p1</h1>", "<p>first</p>"),
                          web_page("page2", "<h1>p2</h1>", "<p>second</p>"),
                         ])).to eq([chapter("first", "p1", 1), chapter("second", "p2", 2)])
  end

  it "should default the title if none found" do
    expect(subject.parse([web_page("page1", "<p>first</p>"),
                          web_page("page2", "<p>second</p>"),
